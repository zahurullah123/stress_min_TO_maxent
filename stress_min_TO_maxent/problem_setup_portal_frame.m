function [coords, conn, dm, numnode, numcell, freedofs, coords_trac, W]= ...
                                    problem_setup_portal_frame(dmax, rmin)

addpath('~zahurullah/Desktop/bbb/Portal_frame/')           
load elements.dat
conn=elements(:,2:5)';
...
%Find out the dirichlet dofs fully fixed 
fix_dofs1=2*bc_x-1; %left side fully fixed
fix_dofs2=2*bc_y;   %left side fully fixed
